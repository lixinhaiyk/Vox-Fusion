...
if __name__ == '__main__':
    ...
    gt_mesh = os.path.join(root_path, f'cull_replica_mesh/{scene_id}.ply')
    rec_mesh = os.path.join('.', f'logs/replica/room0/2023-03-11-20-57-41/mesh/final_mesh.ply')

    calc_3d_metric(rec_mesh, gt_mesh)
